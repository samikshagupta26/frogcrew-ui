    ...
    <div class="bg-white shadow-lg rounded-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-purple-800 p-8 text-white">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    <div
                        class="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-lg ring-4 ring-purple-100">
                    ...
                    <div>
                        ...
                        <p class="text-purple-100 text-lg mt-1">{{ profile.role }}</p>
                    </div>
                </div>
        ...
        <div v-else class="p-8">
            ...
            <div class="bg-purple-50 rounded-xl p-8 mb-8">
                <h4 class="text-xl font-semibold text-purple-900 mb-6">Contact Information</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-purple-900">{{ profile.email }}</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="bg-purple-100 p-3 rounded-full">
                        ...
                        <div>
                            <p class="text-sm text-purple-600">Phone</p>
                            <p class="text-lg font-medium text-purple-900">{{ profile.phoneNumber }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-purple-50 rounded-xl p-8">
                <h4 class="text-xl font-semibold text-purple-900 mb-6">Assigned Positions</h4>
                <div v-if="profile.positionIds && profile.positionIds.length > 0" class="flex flex-wrap gap-4">
                    <div v-for="positionId in profile.positionIds" :key="positionId"
                        class="bg-white px-6 py-3 rounded-full border border-purple-200 text-purple-700 font-medium text-lg shadow-sm hover:shadow-md transition-all hover:scale-105">
                        {{ positionId }}
                    </div>
                </div>
                <div v-else class="text-purple-600 italic text-lg">
